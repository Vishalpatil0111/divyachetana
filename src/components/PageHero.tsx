  ...
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
        {eyebrow && (
          <span className="animate-fade-up text-xs font-medium uppercase tracking-widest text-primary">
            {eyebrow}
          </span>
        )}
        ...
        {description && (
          <p className="animate-fade-up delay-200 mt-5 text-lg text-muted-foreground max-w-2xl leading-relaxed">
            {description}
          </p>
        )}
