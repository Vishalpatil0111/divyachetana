...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Reach the foundation -Malad West office, phone, email, and a quick message form.",
      },
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2 space-y-6">
          <InfoCard
            icon={MapPin}
            title="Address"
            lines={["A wing 1402 Galaxy Height 57,", "Jankalyan Nagar, Malad West 400095"]}
          />
        ...
        >
          ...
          <button
            type="submit"
            className="mt-6 inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-6 py-3 font-medium hover:opacity-90 transition"
          >
