    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-7">
            ...
            <Reveal
              as="h1"
              delay={80}
              className="text-3xl md:text-4xl lg:text-5xl leading-[1.15] font-semibold text-foreground"
            >
            ...
            >
              Supporting children affected by COVID, severe illness, accidents, heart attacks,
              financial crises, and loss of earning members through education and long-term care.
            </Reveal>
            ...
            >
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-primary" /> Section 8 registered
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-primary" /> 80G tax exempt
              </div>
            </Reveal>
          </div>
          ...
          <Reveal y={40} delay={120} className="relative">
            <div
              className="h-96 md:h-[34rem] lg:h-[40rem] rounded-3xl overflow-hidden"
              style={{ boxShadow: "var(--shadow-warm)" }}
            >
              <img
                src="/images/gallery/WhatsApp Image 2024-12-10 at 8.07.39 AM (1).jpeg"
                alt="Children supported by Divyachetana"
            ...
            <div className="absolute -bottom-6 -left-6 md:-left-10 bg-background p-6 rounded-2xl shadow-xl max-w-xs border border-border">
              ...
              <p className="text-foreground leading-snug font-medium">
                "Every child deserves a chance to succeed, regardless of the hardships they face."
              </p>
              <div className="mt-4 flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-primary-soft flex items-center justify-center text-primary text-[11px] font-bold">
                  DC
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 md:py-28 grid md:grid-cols-12 gap-12 items-center">
        <Reveal y={40} className="md:col-span-5">
          <img
            src="/images/gallery/WhatsApp Image 2026-02-14 at 12.42.32 PM.jpeg"
            alt="A supported student at study"
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          <Reveal as="p" delay={160} className="text-muted-foreground leading-relaxed text-lg">
            Divyachetana Social Foundation provides care and support to children who have lost their
            parents. We pay school and college fees, distribute books, stationery and uniforms, and
            walk with each child through counselling, mentorship and career guidance — until they're
            standing on their own.
          </Reveal>
          <Reveal delay={240}>
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-primary font-semibold border-b-2 border-primary/20 hover:border-primary pb-1 transition"
            >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            <Reveal className="max-w-xl">
              ...
              <p className="mt-5 text-sm font-medium uppercase tracking-[0.2em] text-muted-foreground">
                Our core initiatives for every child we support
              </p>
              <p className="mt-4 text-muted-foreground">
                Practical, long-term support -so no child's education ever stops because of a loss
                they didn't choose.
              </p>
            </Reveal>
          </div>
            ...
            {[
              {
                ...
                body: "We cover school and college fees so learning never pauses for a child who has lost a parent.",
              },
              {
                icon: BookOpen,
                title: "Books, Uniforms & Kits",
                body: "Books, notebooks, stationery and uniforms -everything a child needs to walk into a classroom with dignity.",
              },
              {
                icon: HeartHandshake,
                title: "Counselling & Care",
                body: "A safe space for children to share, grieve and grow with our trained counsellors.",
              },
              {
                icon: Users,
                title: "Mentorship & Career Guidance",
                body: "Mentors who help children prepare CVs and applications -and step confidently into their first job.",
              },
            ].map((p, i) => (
              <Reveal
                key={p.title}
                delay={(i % 4) * 90}
                className="group p-8 rounded-3xl bg-background border border-border hover:border-primary/40 hover:bg-primary-soft/30 transition-all hover-lift"
              >
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="max-w-xl">
              ...
              <h2 className="mt-3 text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.05] tracking-tight">
                Verified, audited, and available.
              </h2>
              <p className="mt-4 text-muted-foreground">
                Our registration certificates are available in full so everyone can verify our
                compliance.
              </p>
            </div>
          </div>
          <div className="grid gap-6 sm:grid-cols-2">
            {[
              ...
              {
                src: "/images/certificates/DivyachetnaCOI.jpeg",
              ...
              >
                <img
                  src={image.src}
                  alt={image.alt}
                  className="h-[36rem] w-full object-cover transition duration-300 ease-in-out hover:scale-105"
                />
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-24">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <Reveal delay={100}>
              <Link
                to="/events"
                className="text-primary font-semibold border-b-2 border-primary/20 hover:border-primary pb-1 transition inline-flex items-center gap-2"
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Reveal
                key={e.t}
                delay={i * 100}
                className="group rounded-3xl border border-border p-7 bg-background hover-lift"
              >
                ...
                <Link
                  to="/events"
                  className="mt-4 inline-flex items-center gap-1.5 text-sm text-muted-foreground group-hover:text-primary transition"
                >
      ...
      <section className="border-t border-border">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <span className="text-xs font-medium uppercase tracking-widest text-primary mb-10 block text-center">
            Supported by
          </span>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={s}
                className="inline-flex items-center px-5 py-2.5 rounded-full border border-border bg-background text-xs font-semibold text-muted-foreground transition hover:border-primary hover:text-foreground"
              >
                {s}
              </span>
            ))}
