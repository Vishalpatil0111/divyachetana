...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Section 8 non-profit supporting 200+ students across Nashik with fees, books, uniforms, counselling and career guidance." },
    ],
  }),
});
...
const directors = [
  { name: "Mr. Madhukar Brahmankar", role: "President", img: "/images/directors/Mr.Madhukar Brahmankar.jpeg" },
  { name: "Mrs. Kanta Rathi", role: "Vice President", img: "/images/directors/Mrs Kanta Rathi.jpeg" },
  { name: "Mr. Prashant Patil", role: "Hon. Secretary", img: "/images/directors/Prashant Patil.jpeg" },
  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-14 items-center">
        <img src="/images/New folder/WhatsApp Image 2026-02-28 at 3.07.57 PM.jpeg" alt="A student studying" className="rounded-3xl object-cover aspect-[4/5] w-full animate-zoom-in hover-lift" loading="lazy" />
        <div>
      ...
      <section className="bg-card border-y border-border">
        <div className="max-w-6xl mx-auto px-6 py-20">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.05] tracking-tight">How we work.</h2>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          <span className="text-xs font-medium uppercase tracking-widest text-primary">Leadership</span>
          <h2 className="mt-3 text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.05] tracking-tight">Directors.</h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {directors.map((p) => (
            <div key={p.name} className="text-center">
              <div className="aspect-square rounded-2xl overflow-hidden bg-muted">
                <img src={p.img} alt={p.name} loading="lazy" className="h-full w-full object-cover object-top hover:scale-105 transition duration-300" />
              </div>
              <p className="mt-3 text-base font-bold uppercase tracking-wider text-primary">{p.role}</p>
        ...
        <div className="text-center mt-20 mb-14">
          ...
          <h2 className="mt-3 text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.05] tracking-tight">Our members.</h2>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 text-center">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold leading-[1.05] tracking-tight max-w-2xl mx-auto">Walk with us.</h2>
